                            ...
                            <div class="mb-4">
                                ...
                                <div class="row g-3 mt-1">
                                    <div class="col-md-6">
                                        ...
                                        <textarea class="form-control" rows="4">{{$bio ?? 'Расскажите о себе...'}}</textarea>
                                    </div>
                                </div>
                            </div>
...
{{--                                            </div>--}}
                                            <div class="col-4">
                                                <input type="tel" class="form-control" id="ec-mobile-number" aria-describedby="emailHelp" placeholder="+79998887766" value="{{$phone}}"/>
                                            </div>
                                            <div class="col-sm-3">
