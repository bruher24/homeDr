...
@section('main')
    <div class="p-4 p-md-5 mb-4 rounded text-body-emphasis bg-body-secondary">
        <div class="col-lg-6 px-0">
            <h1 class="display-4 fst-italic">Какой-то главный пост</h1>
            <p class="lead my-3">Текст какого-то главного поста</p>
            <p class="lead mb-0"><a href="#" class="text-body-emphasis fw-bold">Читать</a></p>
        </div>
    </div>
    ...
    <div class="row mb-2">
        <div class="col-md-6">
            <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                <div class="col p-4 d-flex flex-column position-static">
                    <strong class="d-inline-block mb-2 text-primary-emphasis">Раздел/категория 1</strong>
                    <h3 class="mb-0">Заголовок поста</h3>
                    <div class="mb-1 text-body-secondary">1 января</div>
                    <p class="card-text mb-auto">Детали поста</p>
                ...
                <div class="col-auto d-none d-lg-block">
                    <svg class="bd-placeholder-img" width="200" height="250" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <image height="100%" width="100%" href=""></image>
                    </svg>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                <div class="col p-4 d-flex flex-column position-static">
                    <strong class="d-inline-block mb-2 text-success-emphasis">Раздел/категория 2</strong>
                    <h3 class="mb-0">Заголовок поста</h3>
                    <div class="mb-1 text-body-secondary">1 января</div>
                    <p class="mb-auto">Детали поста</p>
                    <a href="#" class="icon-link gap-1 icon-link-hover stretched-link">
                        Читать
                        <svg class="bi" aria-hidden="true">
                            <use xlink:href="#chevron-right"></use>
                ...
                <div class="col-auto d-none d-lg-block">
                    <svg class="bd-placeholder-img" width="200" height="250" xmlns="http://www.w3.org/2000/svg"
                         role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice"><title>
                            Placeholder</title>
                        <rect width="100%" height="100%" fill="#55595c"></rect>
                        <text x="50%" y="50%" fill="#eceeef" dy=".3em">Thumbnail</text>
                    </svg>
    ...
    <div class="row g-5">
        <div class="col-md-8">
            ...
            <article class="blog-post">
                <h2 class="display-5 link-body-emphasis mb-1">Пост 1</h2>
